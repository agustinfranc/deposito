                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cuit" type="cuit" class="form-control @error('cuit') is-invalid @enderror" name="cuit" value="{{ old('cuit') }}" required autocomplete="cuit">
                        ...
                        <div class="form-group row">
                            <label for="razon" class="col-md-4 col-form-label text-md-right">{{ __('Razon') }}</label>

                            <div class="col-md-6">
                                <input id="razon" type="razon" class="form-control @error('razon') is-invalid @enderror" name="razon" value="{{ old('razon') }}" required autocomplete="razon">
